...
function digHole(site, instance) {
  var range = Decoration$GclAtom.Site.toRange(site, instance[/* specifications */5]);
...
var partial_arg = Decoration$GclAtom.Site.decode;

function partial_arg$1(param) {
  return Json_decode.pair(partial_arg, decodeKind, param);
}
...
function handle(error) {
  ...
  if (typeof kind === "number") {
    return /* :: */Caml_chrome_debugger.simpleVariant("::", [
              /* AddDecoration */Caml_chrome_debugger.variant("AddDecoration", 2, [(function (param, param$1) {
              ...
              /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  /* Display */Caml_chrome_debugger.variant("Display", 6, [
                      ...
                      /* Plain */Caml_chrome_debugger.variant("Plain", 1, [Decoration$GclAtom.Site.toString(site)])
                    ]),
                  /* [] */0
                ])
            ]);
              ...
              case /* DigHole */4 :
                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                                    console.log("dig!");
                                    return P$GclAtom.let_(digHole(site, instance), (function (param) {
  ...
  switch (response.tag | 0) {
    ...
    case /* OK */1 :
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  ...
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* AddDecoration */Caml_chrome_debugger.variant("AddDecoration", 2, [(function (specifications, editor) {
    ...
    case /* Resolve */2 :
        ...
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                          return P$GclAtom.let_(resolve(i, instance), (function (param) {
                                        return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      /* DispatchLocal */Caml_chrome_debugger.variant("DispatchLocal", 4, [/* Save */1]),
                                                      /* [] */0
                                                    ]));
