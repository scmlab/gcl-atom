...
var Base2$GclAtom = require("./Base2.bs.js");
          ...
          case "AtAbort" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
                                        ...
                                        }), View$Guacamole.Loc.decode, param);
                          })]);
          case "AtAssertion" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
...
function decode$2(json) {
  return {
          ...
          loc: Json_decode.field("specLoc", View$Guacamole.Loc.decode, json)
        };
}
...
function toLoc(site, specifications) {
  if (site.tag) {
    ...
    return Belt_Option.mapWithDefault(Belt_Array.get(specs, 0), loc, (function (spec) {
                  return View$Guacamole.Loc.translateBy(1, 0, 1, 0, View$Guacamole.Loc.translate(loc, spec.loc));
                }));
  } else {
    return site[0];
  }
...
function toString$1(site) {
  if (site.tag) {
    return "at " + (View$Guacamole.Loc.toString(site[0]) + (" in #" + String(site[1])));
  } else {
    return "at " + View$Guacamole.Loc.toString(site[0]);
  }
}
        ...
        switch (tag) {
          case "Global" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (json) {
                            return /* Global */Caml_chrome_debugger.variant("Global", 0, [Curry._1(View$Guacamole.Loc.decode, json)]);
                          })]);
          case "Local" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          ...
                                          return Json_decode.pair(View$Guacamole.Loc.decode, Json_decode.$$int, param);
                                        }), param);
                          })]);
          default:
            throw [
          ...
          case "NotFunction" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          ...
                                          return Json_decode.pair(Syntax$GclAtom.Type.decode, View$Guacamole.Loc.decode, param);
                                        }), param);
                          })]);
          case "NotInScope" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          ...
                                          return Json_decode.pair(Json_decode.string, View$Guacamole.Loc.decode, param);
                                        }), param);
                          })]);
          case "RecursiveType" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          ...
                                          return Json_decode.tuple3(Json_decode.$$int, Syntax$GclAtom.Type.decode, View$Guacamole.Loc.decode, param);
                                        }), param);
                          })]);
          case "UnifyFailed" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          ...
                                          return Json_decode.tuple3(Syntax$GclAtom.Type.decode, Syntax$GclAtom.Type.decode, View$Guacamole.Loc.decode, param);
                                        }), param);
                          })]);
          default:
            throw [
              ...
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (pairs) {
                                          ...
                                          return Json_decode.array((function (param) {
                                                        return Json_decode.pair(View$Guacamole.Loc.decode, Json_decode.string, param);
                                                      }), param);
                                        }), param);
                          })]);
          case "TypeError" :
