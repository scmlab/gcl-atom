  ...
  return Decoder$GclAtom.sum((function (tag) {
                  switch (tag) {
                    case "Conjunct" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (xs) {
                                                    return /* Conjunct */Caml_chrome_debugger.variant("Conjunct", 2, [xs]);
                                                  }), (function (param) {
                    ...
                    case "Disjunct" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (xs) {
                                                    return /* Disjunct */Caml_chrome_debugger.variant("Disjunct", 3, [xs]);
                                                  }), (function (param) {
                                                    return Json_decode.array(decode$5, param);
                                                  }), param);
                                    })]);
                    case "Guard" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (e) {
                                                    return /* Guard */Caml_chrome_debugger.variant("Guard", 1, [e]);
                                                  }), decode$4, param);
                                    })]);
                    case "LoopBaseConj" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* LoopBaseConj */Caml_chrome_debugger.variant("LoopBaseConj", 7, [
                                                              param[0],
                                                              param[1]
                                                            ]);
                                                  }), (function (param) {
                                                    return Json_decode.pair(decode$5, (function (param) {
                    ...
                    case "LoopIndConj" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* LoopIndConj */Caml_chrome_debugger.variant("LoopIndConj", 6, [
                                                              param[0],
                                                              param[1]
                                                            ]);
                                                  }), (function (param) {
                                                    return Json_decode.pair(decode$5, decode$4, param);
                                                  }), param);
                                    })]);
                    case "LoopTermConj" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* LoopTermConj */Caml_chrome_debugger.variant("LoopTermConj", 5, [
                                                              param[0],
                                                              param[1]
                                                            ]);
                                                  }), (function (param) {
                    ...
                    case "LoopTermDecrConj" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* LoopTermDecrConj */Caml_chrome_debugger.variant("LoopTermDecrConj", 4, [
                                                              param[0],
                                                              param[1],
                                                              param[2]
                                                            ]);
                                                  }), (function (param) {
                                                    return Json_decode.tuple3(decode$5, decode$4, decode$4, param);
                                                  }), param);
                                    })]);
                    case "Pred" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (x) {
                                                    return /* Pred */Caml_chrome_debugger.variant("Pred", 0, [x]);
                                                  }), decode$4, param);
                                    })]);
                    default:
                      throw [
