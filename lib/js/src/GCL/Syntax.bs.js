  ...
  return Decoder$GclAtom.sum((function (tag) {
                  switch (tag) {
                    ...
                    case "Conjunct" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (xs) {
                                                    return /* Conjunct */Caml_chrome_debugger.variant("Conjunct", 4, [xs]);
                                                  }), (function (param) {
                    ...
                    case "Disjunct" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (xs) {
                                                    return /* Disjunct */Caml_chrome_debugger.variant("Disjunct", 5, [xs]);
                                                  }), (function (param) {
                                                    return Json_decode.array(decode$5, param);
                                                  }), param);
                                    })]);
                    case "Guard" :
                        ...
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* Guard */Caml_chrome_debugger.variant("Guard", 3, [
                                                              param[0],
                                                              param[1],
                                                              param[2]
                                                            ]);
                    ...
                    case "Negate" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (x) {
                                                    return /* Negate */Caml_chrome_debugger.variant("Negate", 6, [x]);
                                                  }), decode$5, param);
                                    })]);
                    default:
                      throw [
