...
function disjunct$prime(param) {
  if (param) {
    return disj(param[0], disjunct$prime(param[1]));
  } else {
...
function conjunct$prime(param) {
  if (param) {
    return disj(param[0], conjunct$prime(param[1]));
  } else {
    return /* Lit */Caml_chrome_debugger.variant("Lit", 2, [
  ...
  return Decoder$GclAtom.sum((function (tag) {
                  switch (tag) {
                    case "Assertion" :
                        ...
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* Assertion */Caml_chrome_debugger.variant("Assertion", 1, [
                                                              param[0],
                                                              param[1]
                                                            ]);
                                                  }), partial_arg$1, param);
                    ...
                    case "Conjunct" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (xs) {
                                                    return /* Conjunct */Caml_chrome_debugger.variant("Conjunct", 3, [xs]);
                                                  }), (function (param) {
                    ...
                    case "Disjunct" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (xs) {
                                                    return /* Disjunct */Caml_chrome_debugger.variant("Disjunct", 4, [xs]);
                                                  }), (function (param) {
                                                    return Json_decode.array(decode$5, param);
                                                  }), param);
                                    })]);
                    case "Guard" :
                        ...
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    return /* Guard */Caml_chrome_debugger.variant("Guard", 2, [
                                                              param[0],
                                                              param[1],
                                                              param[2]
                                                            ]);
                    ...
                    case "Negate" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (x) {
                                                    return /* Negate */Caml_chrome_debugger.variant("Negate", 5, [x]);
                                                  }), decode$5, param);
                                    })]);
                    case "Pred" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
