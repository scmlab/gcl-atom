                    ...
                    case "App" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.tuple3(decode$4, decode$4, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Const" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$2, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Hole" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                    ...
                    case "Lit" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Op" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$1, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Quant" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Util$GclAtom.Decode.tuple5(decode$4, (function (param) {
                                                                ...
                                                                }), decode$4, decode$4, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Var" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$3, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    default:
                      throw [
                    ...
                    case "Assertion" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$4, Base$GclAtom.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Bound" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
