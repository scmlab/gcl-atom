                    ...
                    case "App" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.tuple3(decode$4, decode$4, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Const" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$2, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Hole" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                    ...
                    case "Lit" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Op" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$1, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Quant" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Util$GclAtom.Decode.tuple5(decode$4, (function (param) {
                                                                  return Json_decode.array(decode$3, param);
                                                                }), decode$4, decode$4, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Var" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$3, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    default:
                      throw [
...
function handleExpr(n, param) {
  switch (param.tag | 0) {
    ...
    case /* Quant */5 :
        return /* Complete */Caml_chrome_debugger.variant("Complete", 1, ["< " + (toString$4(0, param[0]) + (" " + (Caml_splice_call.spliceObjApply(" ", "concat", [Belt_Array.map(param[1], toString$3)]) + (" : " + (toString$4(0, param[2]) + (" : " + (toString$4(0, param[3]) + " >")))))))]);
    case /* Hole */6 :
                    ...
                    case "Assertion" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$4, View$Guacamole.Loc.decode, param);
                                                  }), param);
                                    })]);
                    case "Bound" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
...
exports.Pred = Pred;
exports.Type = Type;
/* Util-GclAtom Not a pure module */
