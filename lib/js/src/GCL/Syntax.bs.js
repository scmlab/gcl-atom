                    ...
                    case "App" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.tuple3(decode$4, decode$4, Decoder$GclAtom.range, param);
                                                  }), param);
                                    })]);
                    case "Const" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$2, Decoder$GclAtom.range, param);
                                                  }), param);
                                    })]);
                    case "Hole" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                    ...
                    case "Lit" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode, Decoder$GclAtom.range, param);
                                                  }), param);
                                    })]);
                    case "Op" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$1, Decoder$GclAtom.range, param);
                                                  }), param);
                                    })]);
                    case "Var" :
                        return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                                      return Json_decode.map((function (param) {
                                                    ...
                                                    return Json_decode.pair(decode$3, Decoder$GclAtom.range, param);
                                                  }), param);
                                    })]);
                    default:
                      throw [
