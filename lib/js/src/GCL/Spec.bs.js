...
function getPayloadRange(spec, instance) {
  var start = new Atom.Point(1, 0).translate(Base$GclAtom.Loc.toRange(spec[/* loc */3]).start);
  var end_ = instance[/* editor */0].getBuffer().rangeForRow(Base$GclAtom.Loc.toRange(spec[/* loc */3]).end.row - 1 | 0, true).end;
