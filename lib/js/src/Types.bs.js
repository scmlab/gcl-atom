...
function send(self, param) {
  if (typeof param === "number") {
    if (param !== 0) {
      return $$Promise.map(Curry._1(self.setActivation, false), (function (param) {
                    return true;
                  }));
    } else {
      return $$Promise.map(Curry._1(self.setActivation, true), (function (param) {
                    return true;
                  }));
    }
  } else {
    Curry._1(self.setHeader, param[0]);
    return $$Promise.map(Curry._1(self.setBody, param[1]), (function (param) {
                  return true;
                }));
  }
}
