...
var decode$1 = Decoder$GclAtom.sum((function (tag) {
        switch (tag) {
          case "ObliIfTotal" :
              ...
              var partial_arg$2 = Syntax$GclAtom.Expr.decode;
              var partial_arg$3 = function (param) {
                return Json_decode.tuple3(partial_arg$2, partial_arg$1, Decoder$GclAtom.range, param);
              };
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
          ...
          case "Obligation" :
              var partial_arg$4 = Syntax$GclAtom.Expr.decode;
              var partial_arg$5 = Syntax$GclAtom.Expr.decode;
              var partial_arg$6 = function (param) {
                return Json_decode.tuple4(Json_decode.$$int, partial_arg$5, partial_arg$4, (function (param) {
