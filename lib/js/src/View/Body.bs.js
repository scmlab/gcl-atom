...
var decode = Decoder$GclAtom.sum((function (tag) {
        switch (tag) {
          case "AroundAbort" :
              var partial_arg = Syntax$GclAtom.Loc.decode;
          ...
          case "AroundSkip" :
              var partial_arg$1 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "AssertGuaranteed" :
              var partial_arg$2 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "AssertSufficient" :
              var partial_arg$3 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "Assignment" :
              var partial_arg$4 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "IfBranch" :
              var partial_arg$5 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "IfTotal" :
              var partial_arg$6 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "LoopBase" :
              var partial_arg$7 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "LoopInd" :
              var partial_arg$8 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "LoopInitialize" :
              var partial_arg$9 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "LoopTermBase" :
              var partial_arg$10 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
          ...
          case "LoopTermDec" :
              var partial_arg$11 = Syntax$GclAtom.Loc.decode;
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
...
function Body$ProofObligation(Props) {
  ...
  if (payload.tag) {
    var qs$prime = Rebase.$$Array.map((function (q) {
            return React.createElement(Expr$GclAtom.make, {
                        expr: q
                      });
          }), payload[1]);
    return React.createElement("li", {
                className: "gcl-body-item"
                  ...
                  }, React.createElement(Expr$GclAtom.make, {
                        expr: payload[0]
                      })), React.createElement("span", {
                    className: "gcl-proof-obligation-arrow"
                  }, "⇒"), React.createElement("span", {
                    className: "gcl-proof-obligation-consequent"
                  }, "DEBUG: if total", Util$GclAtom.React.sepBy(React.createElement("br", undefined), qs$prime)));
  } else {
    return React.createElement("li", {
                className: "gcl-body-item"
              }, React.createElement("span", {
...
var decode$1 = Decoder$GclAtom.sum((function (tag) {
        switch (tag) {
          case "ObliIfTotal" :
              ...
              var partial_arg$3 = Syntax$GclAtom.Expr.decode;
              var partial_arg$4 = function (param) {
                return Json_decode.tuple3(partial_arg$3, partial_arg$2, partial_arg, param);
              };
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          return /* IfTotal */Caml_chrome_debugger.variant("IfTotal", 1, [
                                                    param[0],
                                                    param[1],
                                                    param[2]
                                                  ]);
          ...
          case "Obligation" :
              var partial_arg$5 = Syntax$GclAtom.Expr.decode;
              var partial_arg$6 = Syntax$GclAtom.Expr.decode;
              var partial_arg$7 = function (param) {
                return Json_decode.tuple4(Json_decode.$$int, partial_arg$6, partial_arg$5, (function (param) {
                              return Json_decode.array(decode, param);
                            }), param);
              };
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          return /* ProofObligation */Caml_chrome_debugger.variant("ProofObligation", 0, [
                                                    param[0],
                                                    param[1],
                                                    param[2],
                                                    param[3]
