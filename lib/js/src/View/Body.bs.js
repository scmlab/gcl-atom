...
function Body$ProofObligation(Props) {
  ...
  return React.createElement("li", {
              className: "gcl-proof-obligation-item  gcl-body-item"
            }, React.createElement("span", undefined, Pred$GclAtom.toString(payload[1])), React.createElement("span", undefined, Pred$GclAtom.toString(payload[2])));
}
...
function decode(param) {
  return Json_decode.map((function (param) {
                ...
                return Json_decode.tuple3(Json_decode.$$int, Pred$GclAtom.decode, Pred$GclAtom.decode, param);
              }), param);
}
