...
var decode = Decoder$GclAtom.sum((function (tag) {
        switch (tag) {
          ...
          case "LoopBase" :
              ...
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
                                          return /* LoopBase */Caml_chrome_debugger.variant("LoopBase", 6, [x]);
                                        }), partial_arg$6, param);
                          })]);
          case "LoopInitialize" :
              ...
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
                                          return /* LoopInitialize */Caml_chrome_debugger.variant("LoopInitialize", 8, [x]);
                                        }), partial_arg$7, param);
                          })]);
          case "LoopTermBase" :
              ...
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (x) {
                                          return /* LoopTermBase */Caml_chrome_debugger.variant("LoopTermBase", 7, [x]);
                                        }), partial_arg$8, param);
                          })]);
          default:
            throw [
