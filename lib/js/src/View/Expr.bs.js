...
function Expr$Operator(Props) {
  ...
  Props.loc;
  return React.createElement("span", undefined, Syntax$GclAtom.Op.toString(value));
}
...
function handleExpr(n, param) {
  switch (param.tag | 0) {
    case /* Var */0 :
    case /* Const */1 :
        return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement("span", undefined, param[0])]);
    case /* Lit */2 :
        return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement("span", undefined, Syntax$GclAtom.Lit.toString(param[0]))]);
    case /* Op */3 :
        ...
        if (match.tag) {
          ...
          if (match$1.tag) {
            ...
            if (q.tag === /* App */4) {
              ...
              return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(React.Fragment, undefined, s, t)]);
            }
          } else {
    ...
    case /* Hole */5 :
        return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement("span", undefined, "[?]")]);
