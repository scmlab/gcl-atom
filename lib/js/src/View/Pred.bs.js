    ...
    case /* InfixL */0 :
        ...
        return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (p) {
                      return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (q) {
                                    return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Pred$Paren, {
                                                    activate: n > m,
                                                    children: null
                                                  }, React.createElement(make, makeProps(m, p, undefined, /* () */0)), React.createElement(Pred$Space, { }), React.createElement(Pred$Operator, {
                                                        value: op,
                                                        loc: loc
                                                      }), React.createElement(Pred$Space, { }), React.createElement(make, makeProps(m + 1 | 0, q, undefined, /* () */0)))]);
                                  }));
                    }));
    case /* InfixR */1 :
        var m$1 = match[0];
        return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (p) {
                      return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (q) {
                                    return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Pred$Paren, {
                                                    activate: n > m$1,
                                                    children: null
                                                  }, React.createElement(make, makeProps(m$1 + 1 | 0, p, undefined, /* () */0)), React.createElement(Pred$Space, { }), React.createElement(Pred$Operator, {
                                                        value: op,
                                                        loc: loc
                                                      }), React.createElement(Pred$Space, { }), React.createElement(make, makeProps(m$1, q, undefined, /* () */0)))]);
                                  }));
                    }));
    case /* Infix */2 :
        var m$2 = match[0];
        return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (p) {
                      return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (q) {
                                    return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Pred$Paren, {
                                                    activate: n > m$2,
                                                    children: null
                                                  }, React.createElement(make, makeProps(m$2 + 1 | 0, p, undefined, /* () */0)), React.createElement(Pred$Space, { }), React.createElement(Pred$Operator, {
                                                        value: op,
                                                        loc: loc
                                                      }), React.createElement(Pred$Space, { }), React.createElement(make, makeProps(m$2 + 1 | 0, q, undefined, /* () */0)))]);
                                  }));
                    }));
    case /* Prefix */3 :
        var m$3 = match[0];
        return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (p) {
                      return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Pred$Paren, {
                                      activate: n > m$3,
                                      children: null
                                    }, React.createElement(Pred$Operator, {
                                          value: op,
                                          loc: loc
                                        }), React.createElement(Pred$Space, { }), React.createElement(make, makeProps(m$3, p, undefined, /* () */0)))]);
                    }));
    case /* Postfix */4 :
        var m$4 = match[0];
        return Syntax$GclAtom.VarArg.let_(Syntax$GclAtom.VarArg.$$var, (function (p) {
                      return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Pred$Paren, {
                                      activate: n > m$4,
                                      children: null
                                    }, React.createElement(make, makeProps(m$4, p, undefined, /* () */0)), React.createElement(Pred$Space, { }), React.createElement(Pred$Operator, {
                                          value: op,
                                          loc: loc
                                        }))]);
                    }));
    ...
    case /* App */4 :
        ...
        if (match.tag) {
          ...
          if (match$1.tag) {
            var t = match$1[0];
            if (q.tag === /* App */4) {
              return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(React.Fragment, undefined, s, React.createElement(Pred$Paren, {
                                  activate: true,
                                  children: t
                                }))]);
            } else {
              return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(React.Fragment, undefined, s, React.createElement(Pred$Space, { }), t)]);
            }
          } else {
