    ...
    switch (param.tag | 0) {
      ...
      case /* SyntaxError */1 :
          ...
          if (typeof match$2 === "number") {
            ...
            Curry._1(instance[/* view */1][/* setBody */2], /* Plain */Caml_chrome_debugger.simpleVariant("Plain", ["The last statement of the program should be an assertion"]));
            return /* () */0;
          } else {
            switch (match$2.tag | 0) {
              ...
              case /* ExcessBound */2 :
                  ...
                  return markRangeError(match$2[0], instance);
