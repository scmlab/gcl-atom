...
function refine(instance) {
  ...
  if (match !== undefined) {
    ...
    if (match$1 !== undefined) {
      ...
      var indent = " ".repeat(stmtRange.start.column);
      var stmt = "\n" + (indent + instance[/* editor */0].getTextInBufferRange(stmtRange));
      ...
      instance[/* editor */0].getBuffer().setTextInRange(spec[/* range */4], "");
      return Async$GclAtom.resolve(/* () */0);
    }
  } else {
    return Async$GclAtom.resolve(/* () */0);
