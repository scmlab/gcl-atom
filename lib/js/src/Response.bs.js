...
var decode$4 = Decoder$GclAtom.sum((function (tag) {
        if (tag === "SyntaxError") {
          return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (json) {
                        return /* SyntaxError */Caml_chrome_debugger.simpleVariant("SyntaxError", [Curry._1(decode$2, json)]);
                      })]);
        } else {
          throw [
                Json_decode.DecodeError,
...
var decode$6 = Decoder$GclAtom.sum((function (tag) {
        switch (tag) {
          case "Error" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (pairs) {
                                          ...
                                          return Json_decode.array((function (param) {
                                                        return Json_decode.pair(decode$3, decode$4, param);
                                                      }), param);
                                        }), param);
                          })]);
          case "OK" :
