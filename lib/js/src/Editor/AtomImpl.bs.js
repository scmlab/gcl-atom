...
function markBackground(editor, range) {
  var createOverlay = function (text, class_, tail, translation, range, editor) {
  ...
  var createMarker = function (type_, class_, range, editor) {
    var marker = editor.markBufferRange(range);
    var option = {
      type: type_,
      class: class_
  ...
  return [
          createOverlay(text, "overlay-error", true, /* tuple */[
                0,
                0
              ], range, editor),
