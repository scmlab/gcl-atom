  ...
  Curry._1(events.onLink.on, (function (param) {
          switch (param.tag | 0) {
            case /* MouseOver */0 :
                ...
                return /* () */0;
            case /* MouseOut */1 :
                var key$1 = GCL$Guacamole.Loc.toString(param[0]);
...
function Impl(Editor) {
  ...
  var send = function (view, request) {
    return Types$GclAtom.View.send(view, request);
  };
  var recv = function (view, callback) {
    return Types$GclAtom.View.recv(view, callback);
  };
  return {
          make: make$2,
          destroy: destroy,
