    ...
    case /* Activate */0 :
        if (Connection$GclAtom.isConnected(instance[/* connection */2])) {
          ...
          return Async$GclAtom.finalError((function (error) {
                        ...
                        Curry._1(instance[/* view */1][/* setHeader */1], match[0]);
                        Curry._1(instance[/* view */1][/* setBody */2], match[1]);
                        return /* () */0;
        ...
        return Async$GclAtom.finalOk((function (result) {
                      ...
                      return Rebase.$$Option.forEach((function (param) {
                            ...
                            if (filepath !== undefined) {
                              ...
                              Curry._1(instance[/* view */1][/* setHeader */1], "Cannot read filepath ");
                              Curry._1(instance[/* view */1][/* setBody */2], "Please save the file first");
