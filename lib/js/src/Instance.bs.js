...
function getConnection(instance) {
  ...
  if (match !== undefined) {
    ...
    return $$Promise.mapError(Connection$GclAtom.make(/* () */0), (function (e) {
        ...
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  ...
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                              ...
                              return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* DispatchRemote */Caml_chrome_debugger.variant("DispatchRemote", 3, [/* InsertAssertion */Caml_chrome_debugger.variant("InsertAssertion", 2, [match[1]])]),
                                            /* [] */0
                                          ]));
                            })]),
                      /* [] */0
  ...
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      ...
      case /* InsertAssertion */2 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 5, [/* InsertAssertion */Caml_chrome_debugger.variant("InsertAssertion", 2, [param[0]])]),
                    /* [] */0
                  ]);
