    ...
    case /* Save */1 :
        ...
        return Async$GclAtom.thenOk((function (param) {
                        ...
                        if (filepath !== undefined) {
                          ...
                          return Async$GclAtom.resolve(/* Display */Caml_chrome_debugger.variant("Display", 1, [
          ...
          case /* TransformError */2 :
              ...
              if (typeof match$3 === "number") {
                ...
                switch (match$3.tag | 0) {
                  ...
                  case /* DigHole */3 :
                      return Async$GclAtom.thenOk((function (param) {
                                      return dispatchRaw(/* Save */1, instance);
...
function dispatch(request, instance) {
  if (typeof request === "number") {
    ...
    return Async$GclAtom.thenOk((function (param) {
                  ...
                  }))(sendRequest(/* Refine */Caml_chrome_debugger.variant("Refine", 1, [
                      spec[/* id */0],
                      payload
                    ]), instance));
  } else {
    return Async$GclAtom.thenOk((function (param) {
                    return handle(instance, param);
                  }))(sendRequest(/* Load */Caml_chrome_debugger.variant("Load", 0, [request[0]]), instance));
  }
}
