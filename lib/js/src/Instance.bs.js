  ...
  switch (request) {
    case /* Toggle */0 :
        if (instance[/* toggle */2]) {
          return dispatch(/* Activate */0, instance);
        } else {
          return dispatch(/* Deactivate */1, instance);
        }
    case /* Save */1 :
        Rebase.$$Array.forEach((function (prim) {
                prim.destroy();
        ...
        return Async$GclAtom.thenOk((function (param) {
                        ...
                        if (filepath !== undefined) {
                          return dispatch(/* Update */Caml_chrome_debugger.variant("Update", 0, [filepath]), instance);
                        } else {
    ...
    case /* Refine */2 :
        return Rebase.$$Option.mapOr((function (spec) {
                      return dispatch(/* Refine */Caml_chrome_debugger.variant("Refine", 1, [spec]), instance);
...
function dispatch(request, instance) {
  if (typeof request === "number") {
    ...
    var partial_arg$1 = Request$GclAtom.encode(/* Load */Caml_chrome_debugger.variant("Load", 0, [request[0]]));
    return Async$GclAtom.thenOk((function (result) {
                    console.log("[ received json ]", result);
                    console.log("[ received value ]", Response$GclAtom.decode(result));
                    return handle(instance, Response$GclAtom.decode(result));
