                  ...
                  /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                          ...
                          return $$Promise.map($$Promise.Js.$$catch($$Promise.Js.fromBsPromise(instance[/* editor */0].save()), (function (param) {
                                        ...
                                        if (filepath !== undefined) {
                                          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                    /* DispatchRemote */Caml_chrome_debugger.variant("DispatchRemote", 1, [/* Load */Caml_chrome_debugger.variant("Load", 0, [filepath])]),
                                                    /* [] */0
                                                  ]);
                                        } else {
                                          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  ...
                  /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                          return Rebase.$$Option.mapOr((function (spec) {
                                        return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      /* DispatchRemote */Caml_chrome_debugger.variant("DispatchRemote", 1, [/* Refine */Caml_chrome_debugger.variant("Refine", 1, [spec])]),
                                                      /* [] */0
                                                    ]));
                                      }), $$Promise.resolved(/* [] */0), Response$GclAtom.Spec.fromCursorPosition(instance));
                        })]),
                  /* [] */0
                ]);
    case /* Debug */3 :
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  /* DispatchRemote */Caml_chrome_debugger.variant("DispatchRemote", 1, [/* Debug */0]),
                  /* [] */0
                ]);
...
function dispatch$1(param) {
  if (typeof param === "number") {
    return /* :: */Caml_chrome_debugger.simpleVariant("::", [
              /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 3, [/* Debug */0]),
              /* [] */0
            ]);
  } else if (param.tag) {
    var spec = param[0];
    return /* :: */Caml_chrome_debugger.simpleVariant("::", [
              /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                      var payload = Response$GclAtom.Spec.getPayload(spec, instance);
