...
function make(editor) {
  ...
  var view = View$GclAtom.create(editor);
...
function destroy(instance) {
  ...
  return Curry._1(instance[/* view */1][/* destroy */0], /* () */0);
}

function activate(instance) {
  return Curry._1(instance[/* view */1][/* setActivation */1], true);
}

function deactivate(instance) {
  return Curry._1(instance[/* view */1][/* setActivation */1], false);
}

function dispatch(request, instance) {
  switch (request) {
    case /* Activate */0 :
        Curry._1(instance[/* view */1][/* setActivation */1], true);
        if (Connection$GclAtom.isConnected(instance[/* connection */2])) {
          ...
          return Async$GclAtom.finalError((function (error) {
                        ...
                        Curry._1(instance[/* view */1][/* setHeader */2], match[0]);
                        Curry._1(instance[/* view */1][/* setBody */3], match[1]);
                        return /* () */0;
    ...
    case /* Deactivate */1 :
        Connection$GclAtom.disconnect(instance[/* connection */2]);
        Curry._1(instance[/* view */1][/* setActivation */1], false);
        ...
        return Async$GclAtom.finalOk((function (result) {
                      ...
                      return Rebase.$$Option.forEach((function (param) {
                            ...
                            if (filepath !== undefined) {
                              ...
                              Curry._1(instance[/* view */1][/* setHeader */2], "Cannot read filepath ");
                              Curry._1(instance[/* view */1][/* setBody */3], "Please save the file first");
