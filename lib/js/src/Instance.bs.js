...
function handle(error) {
  var handleError = function (_site) {
    return (function (param) {
        switch (param.tag | 0) {
          ...
          case /* SyntacticError */1 :
              var match = param[0];
              var $$location = match[/* location */0];
              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                                Decoration$GclAtom.markError$prime($$location, instance);
                                return Async$GclAtom.resolve(/* [] */0);
                              })]),
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* Display */Caml_chrome_debugger.variant("Display", 4, [
                                /* Error */Caml_chrome_debugger.variant("Error", 1, ["Parse Error"]),
                                /* Plain */Caml_chrome_debugger.variant("Plain", 1, [match[/* message */1]])
                              ]),
                            /* [] */0
                          ])
                      ]);
  ...
  var handleError$prime = function (param) {
    return handleError(param[0])(param[1]);
  };
  switch (error.tag | 0) {
    case /* Error */0 :
        return Js_list.flatten(Rebase.List.fromArray(Rebase.$$Array.map(handleError$prime, error[0])));
    case /* OK */1 :
