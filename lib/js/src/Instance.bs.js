...
function dispatch(_request, instance) {
  while(true) {
    ...
    if (typeof request === "number") {
      if (request === /* Activate */0) {
        ...
        if (Connection$GclAtom.isConnected(instance[/* connection */3])) {
          ...
          return Async$GclAtom.thenOk((function (param) {
                          return dispatch(/* Raw */Caml_chrome_debugger.variant("Raw", 0, [/* Save */1]), instance);
                        }))(Async$GclAtom.thenError((function (error) {
                              var match = Connection$GclAtom.$$Error.toString(error);
                              Curry._1(instance[/* view */1][/* setHeader */1], /* Error */Caml_chrome_debugger.variant("Error", 1, [match[0]]));
                              Curry._1(instance[/* view */1][/* setBody */2], /* Plain */Caml_chrome_debugger.variant("Plain", 1, [match[1]]));
            ...
            switch (request[0]) {
              ...
              case /* Save */1 :
                  ...
                  return Async$GclAtom.thenOk((function (param) {
                                  ...
                                  if (filepath !== undefined) {
                                    return dispatch(/* Update */Caml_chrome_debugger.variant("Update", 1, [filepath]), instance);
                                  } else {
              ...
              case /* Refine */2 :
                  return Rebase.$$Option.mapOr((function (spec) {
                                return dispatch(/* Refine */Caml_chrome_debugger.variant("Refine", 2, [spec]), instance);
                              }), Async$GclAtom.resolve(/* () */0), Handler$GclAtom.Spec.fromCursorPosition(instance));
              
            }
        case /* Update */1 :
            var partial_arg = Request$GclAtom.encode(/* Load */Caml_chrome_debugger.variant("Load", 0, [request[0]]));
            return Async$GclAtom.thenOk((function (result) {
                            ...
                            return handle(instance, Response$GclAtom.decode(result));
                                ...
                                Curry._1(instance[/* view */1][/* setBody */2], /* Plain */Caml_chrome_debugger.variant("Plain", 1, [match[1]]));
                                return /* () */0;
                              }))(Async$GclAtom.thenOk((function(partial_arg){
                                return function (param) {
                                  return Connection$GclAtom.send(partial_arg, param);
                                }
                                }(partial_arg)))(getConnection(instance))));
        case /* Refine */2 :
            var spec = request[0];
            var payload = Handler$GclAtom.Spec.getPayload(spec, instance);
            var partial_arg$1 = Request$GclAtom.encode(/* Refine */Caml_chrome_debugger.variant("Refine", 1, [
                    spec[/* id */0],
                    payload
                  ]));
            return Async$GclAtom.thenOk((function (result) {
                            ...
                            return handle(instance, Response$GclAtom.decode(result));
                                ...
                                Curry._1(instance[/* view */1][/* setBody */2], /* Plain */Caml_chrome_debugger.variant("Plain", 1, [match[1]]));
                                return /* () */0;
                              }))(Async$GclAtom.thenOk((function(partial_arg$1){
                                return function (param) {
                                  return Connection$GclAtom.send(partial_arg$1, param);
                                }
                                }(partial_arg$1)))(getConnection(instance))));
