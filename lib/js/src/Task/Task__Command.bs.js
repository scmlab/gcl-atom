    ...
    case /* Save */1 :
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                          ...
                          return $$Promise.map($$Promise.Js.$$catch($$Promise.Js.fromBsPromise(state[/* editor */0].save()), (function (param) {
                                            return $$Promise.resolved(/* () */0);
                                          })), (function (param) {
                                        var filepath = state[/* editor */0].getPath();
                  ...
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                              return Rebase.$$Option.mapOr((function (spec) {
                                          ...
                                          }), $$Promise.resolved(/* [] */0), Spec$GclAtom.fromCursorPosition(state));
                            })]),
                      /* [] */0
                    ])
                ]);
