...
var Sig$Guacamole = require("guacamole/lib/js/src/Editor/Sig.bs.js");
                  ...
                  /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                          ...
                          return $$Promise.map($$Promise.Js.$$catch($$Promise.Js.fromBsPromise(state.editor.save()), (function (param) {
                                        ...
                                        if (filepath !== undefined) {
                                          ...
                                          if (match) {
                                            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 4, [/* Load2 */Caml_chrome_debugger.variant("Load2", 1, [path])]),
                                                      /* [] */0
                                                    ]);
                                          } else {
                                            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 4, [/* Load */Caml_chrome_debugger.variant("Load", 0, [path])]),
                                                      /* [] */0
                                                    ]);
                                          }
                                        } else {
                      ...
                      /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                              return Belt_Option.mapWithDefault(Spec$GclAtom.fromCursorPosition(state), $$Promise.resolved(/* [] */0), (function (spec) {
                                            ...
                                            return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                          /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 4, [/* Refine */Caml_chrome_debugger.variant("Refine", 2, [
                                                                  spec.id,
                                                                  payload
                                                                ])]),
                                                          /* [] */0
        ...
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  ...
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                              ...
                              var match = Base2$GclAtom.Pos.fromPoint("whatever", cursor);
                              return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 4, [/* InsertAssertion */Caml_chrome_debugger.variant("InsertAssertion", 3, [match[1]])]),
                                            /* [] */0
                                          ]));
                            })]),
                      /* [] */0
