  ...
  var runTask = function (task) {
    switch (task.tag | 0) {
      ...
      case /* SetSpecifications */1 :
          ...
          state[/* specifications */5] = task[0];
          return $$Promise.resolved(/* () */0);
      case /* AddDecorations */2 :
          console.log("[ add decorations ]");
          state[/* decorations */4] = Rebase.$$Array.concat(Curry._2(task[0], state[/* specifications */5], state[/* editor */0]), state[/* decorations */4]);
          return $$Promise.resolved(/* () */0);
      ...
      case /* Display */5 :
          Curry._1(state[/* view */1][/* setHeader */1], task[0]);
          Curry._1(state[/* view */1][/* setBody */2], task[1]);
          return $$Promise.resolved(/* () */0);
