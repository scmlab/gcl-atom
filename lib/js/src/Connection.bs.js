...
function send(request, self) {
  var match = self[/* process */1];
  if (match !== undefined) {
    var $$process = Caml_option.valFromOption(match);
    ...
    console.log("[ send failed, GCL not connected ]");
