...
function connect(connection) {
  return Async$GclAtom.thenOk((function (path) {
                  ...
                  $$process.on("error", (function (exn) {
                            ...
                            return Event$GclAtom.emitError(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* ShellError */Caml_chrome_debugger.variant("ShellError", 0, [exn])]), connection[/* emitter */2]);
                          })).on("close", (function (code, signal) {
                          disconnect(connection);
                          return Event$GclAtom.emitError(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* ClosedByProcess */Caml_chrome_debugger.variant("ClosedByProcess", 1, [
                                            code,
                                            signal
