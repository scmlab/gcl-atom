...
var Resource$GclAtom = require("./Util/Resource.bs.js");
...
function toString(param) {
  switch (param.tag | 0) {
    ...
    case /* AutoSearchError */1 :
        var match = param[0];
        switch (match.tag | 0) {
          case /* ProcessHanging */0 :
              return /* tuple */[
                      "Process not responding when looking for \"" + (match[0] + "\""),
...
function disconnect(connection) {
  ...
  if (typeof match === "number") {
    ...
    var pending = Resource$GclAtom.make(/* () */0);
    connection[/* process */1] = /* Disconnecting */Caml_chrome_debugger.variant("Disconnecting", 1, [pending]);
    Curry._1(connection[/* emitter */2][/* on */3], (function (param) {
            if (param.tag) {
              var match = param[0];
              if (match.tag === /* ConnectionError */3) {
                var tmp = match[0];
                if (typeof tmp === "number" || tmp.tag !== /* ExitedByProcess */2) {
                  return /* () */0;
                } else {
                  Curry._1(connection[/* emitter */2][/* destroy */4], /* () */0);
                  connection[/* process */1] = /* Disconnected */0;
...
function autoSearch(name) {
  ...
  return $$Promise.mapError(match[0], (function (e) {
                return /* AutoSearchError */Caml_chrome_debugger.variant("AutoSearchError", 1, [e]);
              }));
}

function getPath(connection) {
  var match = connection[/* path */0];
  if (match !== undefined) {
    return $$Promise.resolved(/* Ok */Caml_chrome_debugger.variant("Ok", 0, [match]));
  } else {
    return $$Promise.tapOk(autoSearch("gcl"), (function (path) {
...
function connect(connection) {
  return Ok$GclAtom.let_(getPath(connection), (function (path) {
                var $$process = Child_process.spawn(path, /* array */[], {
                      shell: true
                    });
                connection[/* process */1] = /* Connected */Caml_chrome_debugger.variant("Connected", 0, [$$process]);
                ...
                $$process.on("close", (function (code, signal) {
                              Curry._1(connection[/* emitter */2][/* emit */1], /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 3, [/* ClosedByProcess */Caml_chrome_debugger.variant("ClosedByProcess", 0, [
                                              code,
                                              signal
                                            ])])]));
                              disconnect(connection);
                            ...
                            Curry._1(connection[/* emitter */2][/* emit */1], /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 3, [/* DisconnectedByUser */0])]));
                            disconnect(connection);
                            return /* () */0;
                          })).on("error", (function (exn) {
                          Curry._1(connection[/* emitter */2][/* emit */1], /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 3, [/* ShellError */Caml_chrome_debugger.variant("ShellError", 1, [exn])])]));
                          connection[/* path */0] = undefined;
                          disconnect(connection);
                          return /* () */0;
                        })).on("exit", (function (code, signal) {
                        Curry._1(connection[/* emitter */2][/* emit */1], /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 3, [/* ExitedByProcess */Caml_chrome_debugger.variant("ExitedByProcess", 2, [
                                        code,
                                        signal
                                      ])])]));
                        disconnect(connection);
...
function send(request, connection) {
  var match = connection[/* process */1];
  if (typeof match === "number" || match.tag) {
    return $$Promise.resolved(/* Error */Caml_chrome_debugger.variant("Error", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 3, [/* NotEstablishedYet */1])]));
  } else {
