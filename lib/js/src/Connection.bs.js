...
function disconnect(connection) {
  Event$GclAtom.destroy(connection[/* emitter */2]);
...
function connect(connection) {
  return Async$GclAtom.thenOk((function (path) {
                  ...
                  $$process.stdout.on("data", (function (chunk) {
                          ...
                          if (match$1 !== undefined) {
                            ...
                            return Event$GclAtom.emitOk(Caml_option.valFromOption(match$1), connection[/* emitter */2]);
                          } else {
                  ...
                  $$process.on("close", (function (code, signal) {
                                disconnect(connection);
                                return Event$GclAtom.emitError(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* ClosedByProcess */Caml_chrome_debugger.variant("ClosedByProcess", 0, [
                                                  code,
                                                  signal
                                                ])]), connection[/* emitter */2]);
                              })).on("disconnect", (function (param) {
                              disconnect(connection);
                              return Event$GclAtom.emitError(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* DisconnectedByUser */0]), connection[/* emitter */2]);
                            })).on("error", (function (exn) {
                            disconnect(connection);
                            return Event$GclAtom.emitError(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* ShellError */Caml_chrome_debugger.variant("ShellError", 1, [exn])]), connection[/* emitter */2]);
                          })).on("exit", (function (code, signal) {
                          disconnect(connection);
                          return Event$GclAtom.emitError(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* ExitedByProcess */Caml_chrome_debugger.variant("ExitedByProcess", 2, [
                                            code,
                                            signal
                                          ])]), connection[/* emitter */2]);
                        }));
...
function send(request, connection) {
  ...
  if (match !== undefined) {
    var promise = Event$GclAtom.once(connection[/* emitter */2]);
    var payload = Buffer.from(request + "\n");
    Caml_option.valFromOption(match).stdin.write(payload);
    return promise;
  } else {
    return Async$GclAtom.reject(/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [/* NotEstablishedYet */1]));
  }
}
